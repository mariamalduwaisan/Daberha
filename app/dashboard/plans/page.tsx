          ...
          <div className="bg-surface rounded-2xl border border-border p-5">
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex-1">
                ...
                <span className="text-xs text-primary font-medium bg-primary/10 rounded-full px-2 py-0.5 inline-block mt-1">
                  قيد التقدم
                </span>
                <div className="mt-3">
            ...
            <button className="mt-4 w-full py-3 rounded-xl bg-primary text-white font-bold text-sm">
              ← استمرار
            </button>
          </div>
        )}
          ...
          <div className="space-y-3">
            {PLANS.filter((p) => !activePlan || p.id !== activePlan.id).map((plan) => (
              ...
              >
                ...
                <button className="text-xs font-bold text-secondary border border-secondary rounded-full px-3 py-1.5 shrink-0 transition hover:bg-secondary hover:text-white">
                  بدء
                </button>
              </div>
            ))}
